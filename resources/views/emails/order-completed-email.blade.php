...
<body>
    ...
    <p>
        Tu compra se ha completado con exito.

        A continucacion veras los detalles de la compra:
    </p>
    ...
    <div class="container">
        ...
        <div class="section shadow">
            ...
            <ul>
                <li>Apellido y Nombre: <span class="text-right">{{$order->buyer_surname}}, {{$order->buyer_name}}</span>
                </li>
