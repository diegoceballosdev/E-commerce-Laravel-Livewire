    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-900">
        ...
        <form wire:submit.prevent="update">
            ...
            <div
                    ...
                    <select id="category" wire:model="category_id"
                        ...
                        @foreach ($all_categories as $category)
                            <option value="{{$category->id}}" wire:key="{{$category->id}}"
                                {{$product_details->category_id == $category->id ? 'selected' : ''}}>
                                {{$category->name}}
                            </option>
                        @endforeach
                ...
                <div class="sm:col-span-9">
                    <input id="price" type="number" wire:model="product_price" step="0.01"
                ...
                <div class="sm:col-span-9">
                    <input id="stock" type="number" wire:model="product_stock" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
            ...
            <div
                ...
                <div class="sm:col-span-9" x-data="{ uploading: false, progress: 0 }"
                    ...
                    <input id="image" type="file" wire:model="product_image"
                        class="block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:z-10  focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 file:bg-gray-100 file:border-0 file:me-4 file:py-2 file:px-4 dark:file:bg-neutral-700 dark:file:text-neutral-400">
                ...
                <div class="sm:col-span-9">
                        @if ($product_image && is_string($product_image))
                            <img src="{{ asset('storage/' . $product_image) }}"  alt="Img existente" height="300px" width="300px" class="rounded-lg">
                        @elseif ($product_image)
                            <img src="{{ $product_image->temporaryUrl() }}" alt="Img nueva" height="300px" width="300px" class="rounded-lg">
                        @else
                            <img src="{{ asset('images/defecto.jpg') }}" alt="default image" height="300px" width="300px" class="rounded-lg">
                        @endif
					</div>
                ...
                <div class="sm:col-span-9">
                    <textarea id="description" wire:model="product_description"
                        ...
                        rows="6" placeholder="Añadir caracteristicas y detalles del producto.">
                    </textarea>
